...
function createSVG() {
    ...
    var ceY = 120;
    var length = 75;
    var endX1 = ceX - length;
    var endY1 = ceY;
    var endX2 = ceX + length;
    var endY2 = ceY;
    var endX3 = ceX;
    var endY3 = ceY - length;
    var endX4 = ceX;
    var endY4 = ceY + length;

    // Draw the rotating line
    var line1 = document.createElementNS("http://www.w3.org/2000/svg", "line");
    line1.setAttribute("x1", endX1);
    line1.setAttribute("y1", endY1);
    line1.setAttribute("x2", endX2);
    line1.setAttribute("y2", endY2);
    line1.setAttribute("stroke", woodColor);
    line1.setAttribute("stroke-width", 5);
    svg.appendChild(line1);

    animateWindmillBlades(line1, 0);

    var line2 = document.createElementNS("http://www.w3.org/2000/svg", "line");
    line2.setAttribute("x1", endX3);
    line2.setAttribute("y1", endY3);
    line2.setAttribute("x2", endX4);
    line2.setAttribute("y2", endY4);
    line2.setAttribute("stroke", woodColor);
    line2.setAttribute("stroke-width", 5);
    svg.appendChild(line2);

    animateWindmillBlades(line2, 0);

    var line3 = document.createElementNS("http://www.w3.org/2000/svg", "line");
    line3.setAttribute("x1", 175);
    line3.setAttribute("y1", 300);
    line3.setAttribute("x2", ceX);
    line3.setAttribute("y2", ceY);
...
function animateWindmillBlades(blade, delay) {
    const duration = 5; // Animation duration in seconds
    ...
    animation.setAttribute("from", "0 150 120");
    animation.setAttribute("to", "360 150 120");
    animation.setAttribute("dur", duration + "s");
    animation.setAttribute("repeatCount", "indefinite");
    animation.setAttribute("begin", delay + "s");

    blade.appendChild(animation);
